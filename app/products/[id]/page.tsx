...
import {
  ...
  Truck, Shield, RotateCcw, Loader,
} from 'lucide-react';
import { useProducts, useCart } from '../../../hooks';
import Footer from '../../../components/Footer';
import ProductReviews from '../../../components/ui/ProductReview';
...
export default function ProductDetailPage() {
  ...
  if (isLoading) {
    return (
      <div className="pt-[120px] min-h-screen flex items-center justify-center bg-[#faf8f3]">
  ...
  if (!current) {
    return (
      <div className="pt-[120px] min-h-screen flex flex-col items-center justify-center gap-4 bg-[#faf8f3]">
        <p className="text-gray-500">Product not found</p>
        <Link href="/products" className="text-sm font-bold underline hover:text-yellow-600 transition">
          Browse all products
        </Link>
      </div>
    );
      ...
      <div className="pt-[120px] min-h-screen bg-[#faf8f3]">
        <div className="max-w-7xl mx-auto px-6 md:px-10 py-10">
          ...
          <nav className="flex items-center gap-2 text-xs text-gray-400 mb-8">
            ...
            <span>/</span>
            <span className="text-black font-medium line-clamp-1">{current.name}</span>
          </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-14">
            ...
            <div>
              {/* Main image */}
              <div className="aspect-square relative overflow-hidden bg-white mb-4 shadow-sm">
                ...
                {current.discount && (
                  <span className="absolute top-3 left-3 bg-yellow-400 text-black text-[10px] font-black px-2 py-0.5 uppercase tracking-widest">
                    {current.discount}
                  </span>
                )}
              </div>
                  ...
                  {current.images.map((img, i) => (
                    <button
                      ...
                      className={`relative w-16 h-16 flex-shrink-0 overflow-hidden transition-all ${
                        currentImg === i ? 'ring-2 ring-black' : 'ring-1 ring-gray-200 hover:ring-gray-400'
                      }`}
                    >
            ...
            <div className="lg:pt-4">
              <p className="text-xs text-yellow-600 font-bold uppercase tracking-widest mb-2">
                {current.category}
              </p>
              ...
              <div className="flex items-center gap-4 mb-6">
                <div className="flex items-center border border-gray-300">
                  ...
                  <button
                    ...
                    className="w-10 h-12 flex items-center justify-center hover:bg-gray-50 transition disabled:opacity-40"
                ...
                <button
                  ...
                  className={`flex-1 h-12 text-xs font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 ${
                    added
                      ...
                      : 'bg-black text-white hover:bg-yellow-400 hover:text-black disabled:opacity-40 disabled:cursor-not-allowed'
                  }`}
                >
                  <ShoppingBag size={15} />
              ...
              <p className={`text-xs font-medium mb-8 ${
                ...
                {current.stock === 0
                  ? 'Out of stock'
                  : current.stock < 5
                  ? `Only ${current.stock} left in stock — order soon`
          ...
          {/* ── Reviews ─────────────────────────────────────────────────────── */}
          <ProductReviews productId={current._id} />
